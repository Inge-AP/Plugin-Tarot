...
function tarot_render_shortcode() {
    ...
    <div class="start-container" id="startContainer">
      <h1 class="titulo">¿Sobre qué tema deseas consultar?</h1>
    ...
    <div class="carousel-container" id="carouselContainer">
      <div id="cardContainer">
        <h2 class="titulo2">Selecciona 3 cartas</h2>
    ...
    <div class="form-container" id="formContainer">
      <h4 class="subtitulo">¿Cuál es tu nombre?</h4>
      <input
        type="text"
        id="nameInput"
        class="name-input"
    ...
    <div class="form-container" id="phoneContainer">
      <h4 class="subtitulo">¿Cuál es tu número de teléfono?</h4>
