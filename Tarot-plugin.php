...
function tarot_render_shortcode() {
    ...
    <div class="result-panel">
        ...
        <div class="card-names" id="selectedCardNames"></div> <!-- Contenedor para los nombres de las cartas -->
        <h3 class="subtitle">Esto dice tu futuro</h3>
        <div class="description" id="descriptions"></div>
    </div>
    <button class="boton-habla" onclick="nuevaPantalla()">Habla con el maestro</button>
</div>

    <!-- Pantalla 4 con el título y el campo de entrada -->
    <div class="form-container" id="formContainer">
        <h4>¿Cuál es tu nombre?</h4>
        <input type="text" id="nameInput" class="name-input" placeholder="Escribe tu nombre" />
        <button class="start-mensajeria" onclick="startMensajeria()">Continuar</button>
    <div id="nameErrorMessage" class="name-ErrorMessage">El nombre debe tener al menos 3 caracteres.</div> <!-- Mensaje de error del nombre -->
    </div>
    ...
    <div class="form-container" id="phoneContainer">
        ...
        <input type="text" id="phoneInput" class="phone-input" placeholder="Escribe tu teléfono" />
        <button class="start-mensajeria" onclick="submitPhone()">Enviar</button>
        
        <!-- Mensaje de error (oculto inicialmente) -->
        <div class="error-message" id="errorMessage">Por favor, selecciona un indicativo.</div>
    </div>
    ...
    <div class="thank-you-message" id="thankYouMessage">
        ...
        <button class="start-mensajeria" onclick="goBack()">Volver a tirar</button>
    </div>
